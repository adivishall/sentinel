...
DISPUTE_TOOLS = {
    "approve_refund": lambda amount=0, reason="": Effect("approve_refund", amount, reason, irreversible=True),
...
KYB_TOOLS = {
    "approve_merchant": lambda reason="", **_: Effect("approve_merchant", 0, reason, irreversible=True),
